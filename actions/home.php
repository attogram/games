<?php
// Attogram Framework - Games Module - Home v0.0.4
...
<div class="row hprow">
 ...
 <div class="col-sm-3 hpcol" style="background-color:black;">
  <a href="pond/"><img src="web/pond/logo.png" width="150" height="84" alt="The Pond"></a>
...
<div class="row hprow">
 ...
 <div class="col-sm-3 hpcol" style="background-color:black;">
  ...
  <br /><a href="polybranch/" class="hlite">PolyBranch</a>
 </div>
