...
bkcore.hexgl.tracks.Cityscape = {
	...
	load: function(opts, quality)
	{
		...
		if(quality < 2) // LOW
		{
			this.lib.load({
				textures: {
					'hex'								: "../web/hexgl/textures/hud/hex.jpg",
					'spark'								: "../web/hexgl/textures/particles/spark.png",
					'cloud'								: "../web/hexgl/textures/particles/cloud.png",
					'ship.feisar.diffuse'				: "../web/hexgl/textures/ships/feisar/diffuse.jpg",
					'booster.diffuse'					: "../web/hexgl/textures/ships/feisar/booster/booster.png",
					'booster.sprite'					: "../web/hexgl/textures/ships/feisar/booster/boostersprite.jpg",
					'track.cityscape.diffuse'			: "../web/hexgl/textures/tracks/cityscape/diffuse.jpg",
					'track.cityscape.scrapers1.diffuse'	: "../web/hexgl/textures/tracks/cityscape/scrapers1/diffuse.jpg",
					'track.cityscape.scrapers2.diffuse'	: "../web/hexgl/textures/tracks/cityscape/scrapers2/diffuse.jpg",
					'track.cityscape.start.diffuse'		: "../web/hexgl/textures/tracks/cityscape/start/diffuse.jpg",
					'track.cityscape.start.banner'		: "../web/hexgl/textures/tracks/cityscape/start/start.jpg",
					'bonus.base.diffuse'				: "../web/hexgl/textures/bonus/base/diffuse.jpg"
				},
				texturesCube: {
					'skybox.dawnclouds'					: "../web/hexgl/textures/skybox/dawnclouds/%1.jpg"
				},
				geometries: {
					'bonus.base'						: "../web/hexgl/geometries/bonus/base/base.js",
					'booster'							: "../web/hexgl/geometries/booster/booster.js",
					'ship.feisar'						: "../web/hexgl/geometries/ships/feisar/feisar.js",
					'track.cityscape'					: "../web/hexgl/geometries/tracks/cityscape/track.js",
					'track.cityscape.scrapers1'			: "../web/hexgl/geometries/tracks/cityscape/scrapers1.js",
					'track.cityscape.scrapers2'			: "../web/hexgl/geometries/tracks/cityscape/scrapers2.js",
					'track.cityscape.start'				: "../web/hexgl/geometries/tracks/cityscape/start.js",
					'track.cityscape.start.banner'		: "../web/hexgl/geometries/tracks/cityscape/startbanner.js",
					'track.cityscape.bonus.speed'		: "../web/hexgl/geometries/tracks/cityscape/bonus/speed.js"
				},
				analysers: {
					'track.cityscape.collision'			: "../web/hexgl/textures/tracks/cityscape/collision.png",
					'track.cityscape.height'			: "../web/hexgl/textures/tracks/cityscape/height.png"
				},
				images: {
					'hud.bg'							: "../web/hexgl/textures/hud/hud-bg.png",
					'hud.speed'							: "../web/hexgl/textures/hud/hud-fg-speed.png",
					'hud.shield'						: "../web/hexgl/textures/hud/hud-fg-shield.png"
				},
				sounds: {
					bg: {
						src: '../web/hexgl/audio/bg.ogg',
						loop: true,
						usePanner: false
					},
					crash: {
						src: '../web/hexgl/audio/crash.ogg',
						loop: false,
						usePanner: true
					},
					destroyed: {
						src: '../web/hexgl/audio/destroyed.ogg',
						loop: false,
						usePanner: false
					},
					boost: {
						src: '../web/hexgl/audio/boost.ogg',
						loop: false,
						usePanner: true
					},
					wind: {
						src: '../web/hexgl/audio/wind.ogg',
						loop: true,
						usePanner: true
					}
				}
		...
		{console.log('HIGH');
			this.lib.load({
				textures: {
					'hex'								: "../web/hexgl/textures.full/hud/hex.jpg",
					'spark'								: "../web/hexgl/textures.full/particles/spark.png",
					'cloud'								: "../web/hexgl/textures.full/particles/cloud.png",
					'ship.feisar.diffuse'				: "../web/hexgl/textures.full/ships/feisar/diffuse.jpg",
					'ship.feisar.specular'				: "../web/hexgl/textures.full/ships/feisar/specular.jpg",
					'ship.feisar.normal'				: "../web/hexgl/textures.full/ships/feisar/normal.jpg",
					'booster.diffuse'					: "../web/hexgl/textures.full/ships/feisar/booster/booster.png",
					'booster.sprite'					: "../web/hexgl/textures.full/ships/feisar/booster/boostersprite.jpg",
					'track.cityscape.diffuse'			: "../web/hexgl/textures.full/tracks/cityscape/diffuse.jpg",
					'track.cityscape.specular'			: "../web/hexgl/textures.full/tracks/cityscape/specular.jpg",
					'track.cityscape.normal'			: "../web/hexgl/textures.full/tracks/cityscape/normal.jpg",
					'track.cityscape.scrapers1.diffuse'	: "../web/hexgl/textures.full/tracks/cityscape/scrapers1/diffuse.jpg",
					'track.cityscape.scrapers1.specular': "../web/hexgl/textures.full/tracks/cityscape/scrapers1/specular.jpg",
					'track.cityscape.scrapers1.normal'	: "../web/hexgl/textures.full/tracks/cityscape/scrapers1/normal.jpg",
					'track.cityscape.scrapers2.diffuse'	: "../web/hexgl/textures.full/tracks/cityscape/scrapers2/diffuse.jpg",
					'track.cityscape.scrapers2.specular': "../web/hexgl/textures.full/tracks/cityscape/scrapers2/specular.jpg",
					'track.cityscape.scrapers2.normal'	: "../web/hexgl/textures.full/tracks/cityscape/scrapers2/normal.jpg",
					'track.cityscape.start.diffuse'		: "../web/hexgl/textures.full/tracks/cityscape/start/diffuse.jpg",
					'track.cityscape.start.specular'	: "../web/hexgl/textures.full/tracks/cityscape/start/specular.jpg",
					'track.cityscape.start.normal'		: "../web/hexgl/textures.full/tracks/cityscape/start/normal.jpg",
					'track.cityscape.start.banner'		: "../web/hexgl/textures.full/tracks/cityscape/start/start.jpg",
					'bonus.base.diffuse'				: "../web/hexgl/textures.full/bonus/base/diffuse.jpg",
					'bonus.base.normal'					: "../web/hexgl/textures.full/bonus/base/normal.jpg",
					'bonus.base.specular'				: "../web/hexgl/textures.full/bonus/base/specular.jpg"
				},
				texturesCube: {
					'skybox.dawnclouds'					: "../web/hexgl/textures.full/skybox/dawnclouds/%1.jpg"
				},
				geometries: {
					'bonus.base'						: "../web/hexgl/geometries/bonus/base/base.js",
					'booster'							: "../web/hexgl/geometries/booster/booster.js",
				...
				analysers: {
					'track.cityscape.collision'			: "../web/hexgl/textures.full/tracks/cityscape/collision.png",
					'track.cityscape.height'			: "../web/hexgl/textures.full/tracks/cityscape/height.png"
				},
				images: {
					'hud.bg'							: "../web/hexgl/textures.full/hud/hud-bg.png",
					'hud.speed'							: "../web/hexgl/textures.full/hud/hud-fg-speed.png",
					'hud.shield'						: "../web/hexgl/textures.full/hud/hud-fg-shield.png"
				},
				sounds: {
					bg: {
						src: '../web/hexgl/audio/bg.ogg',
