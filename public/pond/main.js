...
function loadAssets(cb) {
  var imgs = [
    { name: 'logo', src: '../web/pond/assets/logo.png' },
    { name: 'logoSmall', src: '../web/pond/assets/logo-small.png' },
    { name: 'soundOn', src: '../web/pond/assets/sound-on.png' },
    { name: 'soundOff', src: '../web/pond/assets/sound-off.png' },
    {name: 'enter', src: '../web/pond/assets/enter.png'}
  ]
