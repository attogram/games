...
var endSound = ((new Audio()).canPlayType("audio/ogg; codecs=vorbis") != "") ? new Audio("../web/polybranch/sound/end.ogg") : new Audio("../web/polybranch/sound/end.mp3");

for(var i = 0; i < 10; i++){
	var index = (i < 5) ? i : i - 5;
    if((new Audio()).canPlayType("audio/ogg; codecs=vorbis") != ""){
        bells[i] = new Audio("../web/polybranch/sound/_bell"+index+".ogg");
    }else{
        bells[i] = new Audio("../web/polybranch/sound/_bell"+index+".mp3");
    }
}
